...
CREATE TABLE `schedules` (
  ...
  `period` enum('ربيعيه','خريفيه') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ربيعيه' COMMENT 'فتره جدول استعمالات الزمن',
...
INSERT INTO `schedules` (`id`, `pdf_upload`, `group_id`, `department_id`, `department_branch_id`, `period`, `session`, `created_at`, `updated_at`) VALUES
(1, 'dsadsadasd.pdf', 1, 2, 1, 'ربيعيه', 'عاديه', NULL, NULL),
(2, 'dsadsadasd.pdf', 3, 1, 2, 'ربيعيه', 'عاديه', NULL, NULL),
(3, 'dsadsadasd.pdf', 2, 1, 4, 'ربيعيه', 'عاديه', NULL, NULL);
...
ALTER TABLE `schedules`
  ...
  ADD KEY `schedules_department_branch_id_foreign` (`department_branch_id`);
...
--
ALTER TABLE `schedules`
  ADD CONSTRAINT `schedules_department_branch_id_foreign` FOREIGN KEY (`department_branch_id`) REFERENCES `department_branches` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
