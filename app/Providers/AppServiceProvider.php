...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::share('period_normal',Period::query()->where('year_start','=',Carbon::now()->format('Y'))->where('status','=','start')->first());
        View::share('period_remedial',Period::query()->where('year_start','=',Carbon::now()->format('Y'))->where('status','=','start')->first());
