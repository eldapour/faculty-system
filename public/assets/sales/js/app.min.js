...
function sidebarType(e) {
    ...
    "bg-white" == a && n ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c) : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo.png") && (c = o.replace("logo-ct-dark", "logo-ct"), r.src = c), "bg-white" == a && i && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c)
}
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        var B;
        t.classList.add("dark-version"), x.includes("logo.png") && (B = x.replace("logo-ct-dark", "logo-ct"), w.src = B);
