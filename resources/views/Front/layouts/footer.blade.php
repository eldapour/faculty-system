        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <a class="navbar-brand" href="index.html">
                    <img class="mb-4" src="photo/logo.png" alt="no logo">
                </a>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae, iusto quo! Cum nam cumque repellat ex cupiditate laborum veritatis, quidem asperiores itaque! Iure fugit voluptates perferendis temporibus. Vero, odit harum!</p>
                <div class="mt-5 mb-4">
                    ...
                    <li class="mb-3">
                        <div class="d-flex blog">
                            ...
                            <div>
                                ...
                                <p class="color-second">7 march, 2023</p>
                            </div>
                        </div>
                    </li>
                    <li class="mb-3">
                ...
                <ul>
                    <li class="mb-4">
                        <div class="d-flex">
                            ...
                            <div class="d-flex align-items-center"><a class="text-decoration-none phone" href="tel: 01025408606">
                                    01025408606
                                </a></div>
                        </div>
                    </li>
                    <li class="mb-4">
                        <div class="d-flex">
                            ...
                            <div class="d-flex align-items-center"><a class="text-decoration-none phone" href="mailto: info@example.com">
                                    info@example.com
                                </a></div>
                        </div>
                    </li>
