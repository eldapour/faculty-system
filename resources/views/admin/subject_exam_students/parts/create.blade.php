        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="exam_code" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select name="subject_exam_id" class="form-control" required>
                        ...
                        <option value="{{ $subject_exam->id }}" style="text-align: center">{{ $subject_exam->subject->subject_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
