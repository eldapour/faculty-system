                    ...
                    <div class="p-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-12 d-flex justify-content-center">
                                <img src="photo/download.png" style="height: 170px;">
                            </div>
                        </div>
                        <div class="mb-2">
...
<script src="{{asset('certificate_assets')}}/js/bootstrap.bundle.min.js"></script>
<script src="{{asset('certificate_assets')}}/js/all.min.js"></script>
</body>
</html>
