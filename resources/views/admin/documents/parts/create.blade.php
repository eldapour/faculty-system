...
<div class="modal-body">
    <form id="addForm" class="addForm" method="POST" enctype="multipart/form-data" action="{{route('documents.store')}}" >
        @csrf
        ...
        <div class="col-md-12 mb-3">
            ...
            <input type="number" class="form-control" name="national_id_of_person" id="national_id_of_person">
        </div>
