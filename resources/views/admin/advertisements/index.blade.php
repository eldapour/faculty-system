                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{ trans('admin.service') }}</th>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('advertisements.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('advertisements.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('advertisements.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('advertisements.edit',':id')}}');
        editScript();
    </script>
@endsection
