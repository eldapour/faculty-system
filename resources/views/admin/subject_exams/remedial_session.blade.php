...
@section('title')
    {{ trans('admin.session') ." ". trans('admin.remedial') }}
@endsection
@section('page_name')
{{ trans('admin.session') ." ". trans('admin.remedial') }}
@endsection
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('remedialSession')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('subject_exams.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('createRemedial')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('subject_exams.show', ':id')}}');
        editScript();
    </script>
@endsection
