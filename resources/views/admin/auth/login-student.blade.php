                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <div class="d-flex justify-content-center">
                                    <img style="width:100%" src="{{ asset('uploads/university_setting/'.$university_settings->logo) }}" />
                                </div>
                                ...
                                @if (Session::has('message'))
                                    <div style="padding: 8px 15px;text-align: center;" class="alert alert-sucess">{{ Session::get('message') }}</div>
                                @endif
                            </div>
                        </div>
                        <!-- /Login-->
