                    ...
                    <div class=" col-lg-8">
                        <div class="d-none d-lg-flex">
                            ...
                            <a class="brand-logo" href="javascript:void(0);">
                                ...
                                <h2 class="brand-text text-primary ml-1">@lang('login.Account activation')</h2>
                        ...
                        <div class="d-flex d-lg-none justify-content-between mt-2">
                            <div class="d-flex">
                                ...
                                <h4 class="brand-text text-primary ml-1">@lang('login.Account activation')</h4>
                            </div>
...
{{--                        </div>--}}
                    ...
                    <div class="d-flex col-lg-12 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-Active-form mt-2" method="POST" id="ActiveForm" action="{{ route('activeStudents') }}">
                                @csrf
                                <div class="form-group">
                                    <label class="form-label" for="national_id">@lang('admin.national_id')</label>
                                    <input class="form-control" id="national_id" type="number" name="national_id"
