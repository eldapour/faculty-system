            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12 mt-2 mb-3">
                        ...
                        <select name="service_id" class="form-control" required>
                            ...
                            <option value="{{ $service->id }}" style="text-align: center">{{ $service->getTranslation('service_name', app()->getLocale()) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="url_ads">
                    </div>
                </div>
