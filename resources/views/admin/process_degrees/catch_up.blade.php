...
@section('title')
    {{ trans('admin.process_degrees_admin') }}   {{ trans('admin.catch_up') }}
@endsection
@section('page_name')
    {{ trans('admin.process_degrees_admin') }}    {{ trans('admin.catch_up') }}
@endsection
    ...
    <div class="row">
        ...
        <div class="modal fade" id="myModal"  role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">{{ trans('admin.process_degrees_admin') }}</h4>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{ route('process_degrees.catchUp') }}', columns);
        // Delete Using Ajax
