...
@section('title')
    {{ trans('admin.Reasons_for_redress') }}
@endsection
@section('page_name')
    {{ trans('admin.Reasons_for_redress') }}
@endsection
    ...
    <div class="row">
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">{{ trans('admin.reason') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('reasons_redress.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('reasons_redress.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('reasons_redress.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('reasons_redress.edit',':id')}}');
        editScript();
    </script>
@endsection
