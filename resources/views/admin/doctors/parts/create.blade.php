...
<div class="modal-body">
    <form id="addForm" class="addForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <select name="professor_position" id="type" class="form-control select2"
                data-placeholder="Choose professor_position">
                <option value="" selected>{{ trans('admin.select') }}</option>
                <option class="form-control" value="official_professor">{{ trans('admin.official_professor') }}</option>
                <option class="form-control" value="visiting_professor">{{ trans('admin.visiting_professor') }}</option>
            </select>
        </div>
