    ...
    <ul class="side-menu">
        ...
        @if(checkUser('manger'))
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a href="{{ route('categories.index') }}" class="slide-item">{{ trans('admin.categories') }}</a>
                    </li>
        ...
        @if(checkUser('manger'))
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{ trans('admin.Those concerned with evidence and diploma') }}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu">
