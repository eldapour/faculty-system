    ...
    <ul class="side-menu">
        ...
        @if (checkUser('manger'))
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    <i class="fa fa-book-medical side-menu__icon"></i>
                    <span class="side-menu__label">@lang('admin.parts of the site')</span><i class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu">
        ...
        @if (checkUser('manger'))
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">@lang('admin.Usage schedules')</span><i class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu">
        ...
        @if (checkUser('manger'))
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a href="{{ route('document_types.index') }}" class="slide-item">@lang('admin.document_types')</a>
                    </li>
...
{{--                    </a>--}}
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{route('subject_student.index')}}">
            <i class="fe fe-settings side-menu__icon"></i>
            <span class="side-menu__label">وحدات الطالب</span>
        </a>
    </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="#">
                <i class="fe fe-settings side-menu__icon"></i>
                <span class="side-menu__label">الاعلانات الداخليه</span>
            </a>
        </li>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{route('schedules.students.all')}}">
            <i class="fe fe-settings side-menu__icon"></i>
            <span class="side-menu__label">الاستعمالات الزمنيه</span>
        </a>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{route('documents.student')}}">
            <i class="fe fe-settings side-menu__icon"></i>
            <span class="side-menu__label">طلبات الوثائق</span>
        </a>
    </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="#">
                <i class="fe fe-settings side-menu__icon"></i>
                <span class="side-menu__label">سجل المعدلات والنقط</span>
            </a>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{route('processDegreeStudent')}}">
                <i class="fe fe-settings side-menu__icon"></i>
                <span class="side-menu__label">معالجه النقاط</span>
            </a>
        </li>
            <li class="slide">
                <a class="side-menu__item" href="{{route('subject_exams.index')}}">
                    <i class="fe fe-settings side-menu__icon"></i>
                    <span class="side-menu__label">طلبات الاستدراك</span>
                </a>
            </li>
    @endif
</aside>
