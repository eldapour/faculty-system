    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">{{ trans('admin.unit_code') }}</th>
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static"  role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">{{ trans('admin.unit') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('unit.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('unit.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('unit.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('unit.edit',':id')}}');
        editScript();
    </script>
@endsection
