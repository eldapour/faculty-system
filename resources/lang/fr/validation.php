...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "identifier_id" => "Identifiant",
        "university_email" => "Courriel de l'université",
        "first_name" => "Prénom",
        "last_name" => "Nom de famille",
        "password" => "Mot de passe",
        "role.ar" => 'Rôle en arabe',
        "role.en" => 'Rôle en anglais',
        ...
        'pdf_upload' => 'Téléchargement de PDF',
        'service_name.ar' => 'Nom du service Ar',
        'service_name.en' => 'Nom du service En',
        'service_name.fr' => 'Nom du service Fr',
        'service_id' => 'Numéro de service',
        'url_ads' => 'Annonces URL',
        'time_ads' => 'Annonces temporelles',
        "document_name_ar" => "Type de document Ar",
        "document_name_en" => "Type de document En",
        "document_name_fr" => "Type de document Fr",
    ],
