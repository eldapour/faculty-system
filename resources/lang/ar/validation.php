...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'unit_name.ar' =>'اسم باللغة العربية',
        'unit_name.en' =>'اسم باللغة الانجليزية',
        'unit_name.fr' =>'اسم باللغة الفرنسية',
        'year' => 'سنة',
        'email' => 'ايميل',
        'logo' => 'لوجو',
        'address.ar' => 'مكان بالعربي',
        'address.en' => 'مكان بالانجليزي',
        'address.fr' => 'مكان بالفرنسية',
        'facebook_link' => "لينك الفيسبوك",
        "exam_date" => 'تاريخ الامتحان',
        "exam_day" => "يوم الامتحان",
        "time_start" => "وقت بداية الامتحان",
        "time_end" => "وقت نهاية الامتحان",
        ...
        "university_register_year" => "تاريخ التسجيل بالجامعة",
        "national_number" => 'الرقم الوطني',
        "national_id" => "الرقم القومي للبطاقة",
        "identifier_id" => "الرقم الكارنيه الجامعي",
        "university_email" => "الايميل الجامعي",
        "first_name" => "الاسم الاول",
        "last_name" => "الاسم الاخير",
        "password" => "كلمة السر",
        "role.ar" => 'الصفة بالعربي',
        "role.en" => 'الصفة بالانجليزي',
